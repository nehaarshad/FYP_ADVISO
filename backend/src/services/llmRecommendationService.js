...
class LLMRecommendationService {
    ...
    async generateRecommendations(studentData, offeredCourses, allowedCredits,program,studentStatus) {
        const prompt = this.buildPrompt(studentData, offeredCourses, allowedCredits,program,studentStatus);
    ...
    buildPrompt(studentData, offeredCourses, allowedCredits,program,studentStatus) {
        return `
