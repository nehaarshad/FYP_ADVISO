...
//     };
//     setLogs([newLog, ...logs]);
//     setIsModalOpen(false); // Modal band karne ke liye
//     setFormData({ studentName: '', studentID: '', batch: '', decision: '', remarks: '', status: 'In-Process' }); // Reset form
//   };
...
//               type="text"
//               maxLength={5}
//               placeholder="Search 5-Digit ID..."
//               value={searchTerm}
//               onChange={(e) => setSearchTerm(e.target.value)}
//               className="pl-10 pr-4 py-2.5 bg-white border border-slate-200 rounded-xl text-xs font-bold focus:ring-2 ring-amber-400 outline-none w-[200px]"
//             />
//           </div>
//           <button 
//             onClick={() => setIsModalOpen(true)}
//             className="flex items-center gap-2 bg-[#1e3a5f] text-white px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-[#162a45] transition-all shadow-md"
//           >
...
//                 <th className="px-8 py-6 text-[10px] font-black text-slate-400 uppercase tracking-widest">CMS ID</th>
//                 <th className="px-8 py-6 text-[10px] font-black text-slate-400 uppercase tracking-widest">Decision</th>
//                 <th className="px-8 py-6 text-[10px] font-black text-slate-400 uppercase tracking-widest">Remarks</th>
...
//                       <span className="text-[9px] font-black text-amber-500 uppercase">{log.batch}</span>
//                     </div>
//                   </td>
//                   <td className="px-8 py-6">
//                     <span className="text-[11px] font-black text-[#1e3a5f] bg-slate-100 px-2 py-1 rounded">{log.studentID}</span>
//                   </td>
//                   <td className="px-8 py-6 text-[12px] font-black text-[#1e3a5f] uppercase">{log.decision}</td>
//                   <td className="px-8 py-6 max-w-[300px] text-[11px] font-bold text-slate-500 italic">"{log.remarks}"</td>
//                   <td className="px-8 py-6">
//                     <span className={`text-[10px] font-black uppercase ${log.status === 'Approved' ? 'text-emerald-600' : 'text-amber-600'}`}>
//                       {log.status}
//                     </span>
//                   </td>
//                   <td className="px-8 py-6 text-[10px] font-black text-slate-400 uppercase">{log.date}</td>
//                 </tr>
//               ))}
//             </tbody>
//           </table>
...
//       {/* 3. MODAL FORM - Jab New Entry click ho */}
//       {isModalOpen && (
...
//               <h3 className="text-xl font-black text-[#1e3a5f] uppercase tracking-tighter">New Advisory Entry</h3>
...
//                 </div>
//                 <div>
//                   <label className="text-[10px] font-black text-slate-400 uppercase ml-1">CMS ID (5 Digits)</label>
...
//               <div className="grid grid-cols-2 gap-4">
//                 <div>
//                   <label className="text-[10px] font-black text-slate-400 uppercase ml-1">Batch</label>
...
//               <div>
//                 <label className="text-[10px] font-black text-slate-400 uppercase ml-1">Decision Taken</label>
//                 <input required name="decision" value={formData.decision} onChange={handleInputChange} className="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-xs font-bold focus:ring-2 ring-amber-400 outline-none" placeholder="e.g. Course Waiver" />
//               </div>

//               <div>
//                 <label className="text-[10px] font-black text-slate-400 uppercase ml-1">Detailed Remarks</label>
//                 <textarea required name="remarks" rows={3} value={formData.remarks} onChange={handleInputChange} className="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-xs font-bold focus:ring-2 ring-amber-400 outline-none resize-none" placeholder="Add details here..." />
//               </div>

//               <button type="submit" className="w-full bg-[#1e3a5f] text-white py-3.5 rounded-xl font-black text-[12px] uppercase tracking-widest hover:bg-amber-500 transition-all mt-4">
//                 Add Log Entry
//               </button>
//             </form>
//           </div>
