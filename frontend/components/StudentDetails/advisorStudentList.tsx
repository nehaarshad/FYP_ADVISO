                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-center">
                      <button
                        ...
                        className="px-4 py-2 bg-[#1e3a5f] text-white rounded-xl text-[9px] font-bold uppercase hover:bg-[#FDB813] hover:text-[#1e3a5f] transition-all flex items-center gap-2"
                      >
