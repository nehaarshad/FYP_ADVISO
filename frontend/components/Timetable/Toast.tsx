...
const styles: Record<ToastType, string> = {
  success: 'bg-[#1e3a5f] text-white border-l-4 border-emerald-500',
  error: 'bg-red-600 text-white border-l-4 border-red-800',
  info: 'bg-[#1e3a5f] text-white border-l-4 border-[#FDB813]',
};
...
export const Toast: React.FC<Props> = ({
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[100] animate-slide-up">
      <div
        className={`${styles[type]} px-4.5 py-3.5 rounded-2xl shadow-xl flex items-center gap-3.5 min-w-[260px] border border-white/10`}
      >
