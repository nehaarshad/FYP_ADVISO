...
const BlueFilledButton: React.FC<BlueFilledButtonProps> = ({ text, onClick, type = "submit" }) => {
  return ( 
    <motion.button 
      ...
      whileTap={{ scale: 0.98 }}
      onClick={onClick}
      className="w-full bg-[#1e3a5f] text-white py-5 rounded-3xl font-bold text-lg flex items-center justify-center gap-3 shadow-2xl shadow-blue-900/20 transition-all mt-8"
    >
