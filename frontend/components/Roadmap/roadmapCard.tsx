    ...
    <div className="p-6 hover:bg-slate-50/50 transition-all group">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h4 className="font-bold text-[#1e3a5f] text-base uppercase tracking-tight">
              {roadmap.versionName}
            </h4>
        ...
        <div className="flex gap-2">
          <button
            onClick={onAssign}
            className="px-4 py-2 bg-[#FDB813]/20 text-[#1e3a5f] rounded-xl text-[9px] font-bold uppercase tracking-wider hover:bg-[#1e3a5f] hover:text-white transition-all flex items-center gap-2"
          >
            <Link2 size={14} /> Assign to Batch
          </button>
          <button
            onClick={onView}
            className="px-4 py-2 bg-slate-100 text-slate-600 rounded-xl text-[9px] font-bold uppercase tracking-wider hover:bg-[#1e3a5f] hover:text-white transition-all flex items-center gap-2"
          >
