  ...
  return (
    <div className="space-y-4"> {/* Spacing kam kar di */}
      ...
      <div className="bg-white p-5 rounded-[2rem] border border-slate-100 shadow-sm flex flex-col md:flex-row justify-between items-center gap-3">
        <div>
          <h2 className="text-xl font-bold text-[#1e3a5f] uppercase  tracking-tighter">Session Repository</h2>
      ...
      <div className="max-w-2xl mx-auto w-full">
        <div className="bg-white p-7 rounded-[2.5rem] border border-slate-100 shadow-sm">
          <div className="flex items-center gap-2 mb-5 text-[#FDB813]">
            <CloudUpload size={18} />
            <h3 className="font-bold uppercase  text-xs tracking-wider text-[#1e3a5f]">New Upload</h3>
          </div>
          
          <div className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-[9px] font-bold text-slate-400 uppercase tracking-widest ml-1">File Category</label>
            ...
            <div className="border-2 border-dashed border-slate-100 rounded-[2rem] py-10 flex flex-col items-center justify-center text-center group hover:border-[#FDB813]/20 transition-colors cursor-pointer">
              ...
              <p className="text-[9px] font-bold text-slate-300 uppercase tracking-[0.2em]">Drop file to sync</p>
            </div>
          </div>

          <button className="w-full mt-6 bg-[#FDB813] text-[#1e3a5f] py-4 rounded-xl font-bold text-[10px] shadow-lg active:scale-95 transition-all uppercase tracking-widest">
