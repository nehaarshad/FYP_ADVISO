      ...
      >
        ...
        <div className="sticky top-0 bg-white border-b border-slate-100 p-6 flex justify-between items-center z-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-[#1e3a5f] uppercase ">Edit Advisor Profile</h2>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2 group">
                  <label className="text-[10px] font-bold uppercase text-slate-400 ml-5 tracking-widest">
                    Gender *
                  </label>
              ...
              <h3 className="text-sm font-bold text-[#1e3a5f] mb-4">Assign Batch</h3>
              ...
              <div className="space-y-3 pt-2">
                <label className="text-[10px] font-bold uppercase text-slate-400 ml-5 tracking-widest flex items-center gap-1.5">
                    ...
                    advisor.BatchAssignments.map((assignment: any, index: number) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className={`px-2.5 py-1 rounded-lg text-[9px] uppercase font-bold ${
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-3 h-[60px] bg-slate-50 p-1.5 rounded-xl border border-slate-100">
                  <button 
                    ...
                    className={`flex-1 rounded-xl font-bold text-[10px] tracking-widest transition-all flex items-center justify-center gap-2 ${
                      status === "Active" 
