      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between p-6 bg-slate-50 rounded-3xl border border-slate-100 group hover:border-[#FDB813] transition-all">
          ...
          <div className="flex gap-3">
            <button className="p-3 bg-white rounded-xl text-[#1e3a5f] hover:bg-[#1e3a5f] hover:text-white transition-all border border-slate-200"><Eye size={16}/></button>
            <button className="p-3 bg-white rounded-xl text-[#1e3a5f] hover:bg-[#1e3a5f] hover:text-white transition-all border border-slate-200"><Download size={16}/></button>
          </div>
        </div>
      </div>
    </div>
