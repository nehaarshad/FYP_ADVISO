        ...
        <div className="space-y-4">
          {uploadedResults.length === 0 ? (
            ...
            uploadedResults.map((result) => (
              <div
                key={result.id}
                className="flex items-center justify-between p-6 bg-slate-50 rounded-3xl border border-slate-100 group hover:border-[#FDB813] transition-all"
              >
                ...
                uploadProgress < 100 && (
                  <div className="space-y-1">
                    <div className="w-full bg-gray-200 rounded-full h-1.5">
                      <div
                        className="bg-[#FDB813] h-1.5 rounded-full transition-all"
                        style={{
