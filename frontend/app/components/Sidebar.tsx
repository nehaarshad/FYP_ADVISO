...
//   BookOpen, ClipboardList, Bell,AlertTriangle
// } from "lucide-react";
...
//   return (
//       <aside className="w-64 bg-[#1e3a5f] text-white flex flex-col p-6 shrink-0 shadow-xl z-50 h-full">

    

//       {/* Logo Section */}
//       <div className="flex items-center gap-2 mb-10 px-2">
//         <div className="w-8 h-8 bg-amber-400 rounded flex items-center justify-center text-[#1e3a5f] font-bold text-sm shadow-lg shadow-amber-400/20">A</div>
...
//               <p className="px-6 text-[10px] font-black uppercase tracking-[0.2em] text-white/30 mb-2 mt-6">Analytics</p>
