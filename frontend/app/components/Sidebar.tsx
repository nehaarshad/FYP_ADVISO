...
import { 
  ...
  GraduationCap, Briefcase, Info, FileText, 
  UserCog, ShieldCheck
} from "lucide-react";
...
export function Sidebar({ 
  ...
  return (
    <aside className="w-72 bg-[#1e3a5f] text-white hidden lg:flex flex-col shadow-2xl sticky top-0 h-screen z-50 font-sans">
      ...
      <nav className="flex-1 px-4 space-y-1 overflow-y-auto custom-scrollbar">
        ...
        <div className="py-2">
            <p className="px-6 text-[10px] font-black uppercase tracking-[0.2em] text-white/30 mb-2 italic">Users</p>
        ...
        {/* 3. MANAGEMENT */}
        <div className="py-2">
            <p className="px-6 text-[10px] font-black uppercase tracking-[0.2em] text-white/30 mb-2 italic">Management</p>
        ...
        {/* ACADEMICS SECTION REMOVED (Shifted to Overview) */}

        {/* 4. SUPPORT & INFO */}
        <div className="py-4 border-t border-white/5 mt-4">
            <p className="px-6 text-[10px] font-black uppercase tracking-[0.2em] text-white/30 mb-2 italic">Support & Info</p>
            <SidebarItem icon={<FileText size={20}/>} label="Request Forms" active={activeTab === "pending-requests"} onClick={() => setActiveTab("pending-requests")} />
