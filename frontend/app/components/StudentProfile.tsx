    ...
    <div className="animate-in fade-in duration-500 h-full flex flex-col overflow-hidden">
      ...
      <div className="flex items-center justify-between mb-6 shrink-0">
        ...
        <div className="text-[10px] font-black text-slate-300 uppercase tracking-widest">
          Academic Profile / <span className="text-[#1e3a5f]">{student.code}</span>
        </div>
      </div>

      <div className="flex flex-col lg:flex-row gap-8 items-start flex-1 min-h-0 overflow-y-auto pr-2 custom-scrollbar pb-10">
          ...
          <div className="bg-white rounded-[2.5rem] p-8 flex flex-col items-center shadow-sm border border-slate-50">
            ...
            <div className="w-full space-y-3 pt-6 border-t border-slate-50">
              <div className="flex justify-between items-center bg-slate-50/50 p-4 rounded-2xl">
                ...
                <span className="text-[11px] font-black text-[#1e3a5f] uppercase tracking-tighter">F22-BSSE-001</span>
              </div>
              <div className="flex justify-between items-center bg-slate-50/50 p-4 rounded-2xl">
        ...
        <div className="flex-1 flex flex-col gap-6 min-w-0 w-full">
          ...
          {/* STATS BANNER */}
          <div className="bg-[#1e3a5f] rounded-[2.5rem] p-3 text-white border-b-[6px] border-amber-400 shadow-xl relative overflow-hidden group">
            <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="pl-6">
                <p className="text-[10px] text-amber-400 font-black uppercase tracking-[0.3em] mb-2">
              ...
              <div className="bg-white/10 backdrop-blur-md px-9 py-6 rounded-[2.5rem] border border-white/10 min-w-[180px]">
          ...
          {/* ROADMAP AREA */}
          <div className="bg-white rounded-[2.5rem] p-10 shadow-sm border border-slate-100 flex flex-col shrink-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8 overflow-y-auto pr-2 custom-scrollbar">
              {[
